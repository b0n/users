...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'token' => ['type' => 'string', 'length' => 60, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'role_id' => 1,
                'active' => 1,
                'created' => '2018-05-24 04:23:38',
                'modified' => '2018-05-24 04:23:38'
            ],
        ];
        parent::init();
    }
